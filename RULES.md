...
The Arkiv × ETHNS Builder Challenge ("Challenge") is organized by Golem Factory GmbH, doing business as "Arkiv Network" ("Organizer"), in collaboration with Network School ("Community Partner"). By submitting an entry, participants agree to these rules in full.

---

## 2. Eligibility

- Open to individuals and teams worldwide. Participation is hybrid (IRL @ Network School + virtual)
...
- Must address one of the three themes — **AI**, **Privacy**, or **DePIN** — or be an explicit hybrid of two
- Must use Arkiv as the primary data layer
- Must be original work created during the Challenge period (May 16–25, 2026)
...
- Submissions that don't address at least one of the three themes
...
- KYC data will not be shared with third parties except as required by law or with Network School strictly to coordinate the winner's stay (and only after the winner explicitly opts in)
...
All themes are scored on the same rubric. See the [Scoring Rubric](docs/scoring-rubric.md) for the detailed sub-criteria and the [Builder's Guide](docs/builders-guide.md) for examples of shallow vs. deep Arkiv integration.
...
- Treat other participants, organizers, NS residents, and community members with respect
- Not engage in harassment, discrimination, or hostile behavior in any Challenge-related channel (Arkiv Discord, NS channels, X Spaces, IRL @ NS)
